			...
			<div class="flex flex-auto min-w-0">
				...
				<div class="side-nav side-nav-transparent side-nav-expand">
					<div class="side-nav-header">
						<div class="logo px-6" >
							<img style="width: 120px;margin-top:20px" src="../assets/images/logo/logo.png" alt="Site Logo" >
						</div>
					</div>
									...
									<li class="menu-collapse">
										...
										<ul>
											<li data-menu-item="modern-chart" class="menu-item">
												...
												<a class="h-full w-full flex items-center" href="index.php?act=thongke">
									...
									<!-- <li class="menu-collapse">
											...
											<ul>
												...
												<li data-menu-item="modern-skeleton" class="menu-item">
													<a class="h-full w-full flex items-center" href="index.php?act=dsbl">
